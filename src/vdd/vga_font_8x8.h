/* vga_font_8x8.h -- GENERATED by tools/gen-vgafont.py. Do not edit by hand.
 * The IBM VGA 8x8 ROM font (CP437): 256 glyphs, 8 bytes each, bit 7 =
 * leftmost pixel. Source: tools/IBM_VGA_8x8.bin (public-domain ROM dump). */
#ifndef NTVDMEX_VGA_FONT_8X8_H
#define NTVDMEX_VGA_FONT_8X8_H
#include <stdint.h>
static const uint8_t vga_font_8x8[256][8] = {
