...
rem agent (vdmtrig.bat), and (re)asserts the IFEO ntvdm.exe -> vdmhost redirect.
set N=C:\ntvdmex
if not exist %N% md %N%
...
echo --- IFEO: ntvdm.exe -> vdmhost.exe (ADR-0007) ---
reg add "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\ntvdm.exe" /v Debugger /t REG_SZ /d "%N%\vdmhost.exe" /f
echo.
echo Installed. Confirm %N%\vdmhost.exe, %N%\vdmtrig.bat, %N%\dosstub.com exist,
