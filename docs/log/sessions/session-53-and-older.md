# Sessions 53 and older — Session 53 and older -- handoff pointers and the WOW/krnl386 reference blocks

> Split out of `docs/STATE.md` on 2026-09-23. This region was already marked *background only* in STATE.md itself.
