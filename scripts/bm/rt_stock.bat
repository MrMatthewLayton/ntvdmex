...
set T=%1
set BIN=C:\Documents and Settings\All Users\Documents\ntvdmex\bin
set RIG=C:\Documents and Settings\All Users\Documents\ntvdmex\debug\rig
set RES=C:\Documents and Settings\All Users\Documents\ntvdmex\debug\out
set TESTS=C:\Documents and Settings\All Users\Documents\ntvdmex\debug\tests\dos
...
rem s73: run IN PLACE from debug\tests\dos\ -- no copy to C:\test, nothing on C:.
...
set STOCKOUT=%RES%\stock_%RANDOM%.txt
cd /d "%TESTS%"
...
echo ============================================================
echo.
start /wait "" cmd /c ""%TESTS%\%T%" > "%STOCKOUT%" 2>&1"
...
reg add "%IFEO%" /v Debugger /t REG_SZ /d "\"C:\Documents and Settings\All Users\Documents\ntvdmex\bin\ntvdmhost.exe\"" /f >nul
